...
::: {.callout-note}
### 课程定位与使用原则
- 本版本为 **参考答案版**：包含全部 90 节课的代码实现与 3 个核心问答题参考解析。
...
| [**CUDA Kernel 算子开发**](cuda/index.qmd) | 14 | 掌握 GPU 线程映射、归约、Tiling、数值稳定算子与 DeepSeek DeepGEMM/DeepEP 前沿拆解 | C/C++、线性代数、并行编程 |
...
```{mermaid}
flowchart TD
    A["训练系统 (Train 1~5)<br>显存账本与分布式通信"] --> B["CUDA Kernel 算子开发 (14课)<br>含 DeepGEMM & DeepEP"]
