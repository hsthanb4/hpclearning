---
title: CUDA Kernel 面试主线 · 第 1/12 课：线程映射与 grid-stride loop
jupyter: python3
---
...
```{mermaid}
flowchart TD
    Grid["Grid (整个网格)"] --> Block0["Block 0"]
    Grid --> Block1["Block 1"]
    Grid --> BlockN["Block (gridDim.x - 1)"]
    Block0 --> Warp0["Warp 0 (线程 0~31)"]
    Block0 --> Warp1["Warp 1 (线程 32~63)"]
    Warp0 --> T0["Thread 0: a[0] + b[0]"]
    Warp0 --> T1["Thread 1: a[1] + b[1]"]
    Warp0 --> T31["Thread 31: a[31] + b[31]"]
    Note["连续线程访问连续内存地址 → 128字节合并访存 (Coalescing)"]
```
